...
function FundedNgLogo({ className = "" }: { className?: string }) {
  return (
    <div className={`flex flex-col items-end ${className}`}>
      <svg viewBox="0 0 200 42" className="h-7 w-auto sm:h-8" fill="none" aria-hidden="true">
        {/* F with candlesticks */}
        <text
          x="2"
          y="31"
...
export const CertificateCard = forwardRef<HTMLDivElement, { cert: Certificate }>(
  function CertificateCard({ cert }, ref) {
          ...
          >
            ...
            >
              ...
              <rect
                width="100%"
                height="100%"
                fill={`url(#pgrid-${cert.id})`}
                mask={`url(#pmask-${cert.id})`}
              />
            </svg>
        ...
        >
          ...
          >
            ...
            <rect
              width="100%"
              height="100%"
              fill={`url(#grid-${cert.id})`}
              mask={`url(#mask-${cert.id})`}
            />
          </svg>
          ...
          <div className="relative mb-5 px-6 sm:px-8">
            <div className="flex items-end justify-between gap-4">
              ...
              <div className="text-right">
                ...
                <div className="mt-1 font-mono text-[9px] text-white sm:text-[11px]">{dateStr}</div>
