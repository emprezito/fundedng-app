              ...
              <div className="flex-1 min-w-[200px]">
                ...
                {r.orders?.utm_source && (
                  <div className="mt-1 inline-flex items-center gap-1 flex-wrap">
                    <Badge variant="outline" className="border-primary/30 text-primary text-[10px]">{r.orders.utm_source}{r.orders.utm_medium ? ` · ${r.orders.utm_medium}` : ""}</Badge>
                    {r.orders.utm_campaign && <Badge variant="outline" className="text-[10px]">{r.orders.utm_campaign}</Badge>}
                    {r.orders.utm_content && <Badge variant="outline" className="text-[10px]">{r.orders.utm_content}</Badge>}
                  </div>
                )}
              </div>
