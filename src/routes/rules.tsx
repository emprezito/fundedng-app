          ...
          <div className="mt-12 space-y-5">
            {[
              ...
              },
              {
                ...
                body: "Equity dropping to 20% drawdown (trailing from the highest peak) — even momentarily on a spike — is a breach. So is a 4th short-held trade, two short-held trades open at the same time, opening 3+ positions on a single symbol, averaging into a losing position, or any attempt to manipulate price, abuse evaluation-server latency, or coordinate trades across accounts.",
              },
              {
                icon: Ban,
